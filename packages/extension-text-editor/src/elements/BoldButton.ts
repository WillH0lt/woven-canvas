...
export class BoldButtonElement extends SignalWatcher(LitElement) {
  ...
  public connectedCallback(): void {
    ...
    this.isActive = InfiniteCanvas.instance?.store.textEditor.bold as ReadonlySignal<boolean>
  }
  ...
  render() {
    return html`
      ...
      })}"  @click="${() => InfiniteCanvas.instance?.commands.textEditor.toggleBold()}">
        <svg
          viewBox="0 0 384 512"
          fill="currentColor"
        >
