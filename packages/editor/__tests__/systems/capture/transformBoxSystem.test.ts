...
import * as allSingletons from "../../../src/singletons";
import { Block, Aabb, Selected, TransformBox } from "../../../src/components";
import { selectBlock } from "../../../src/helpers";
import { Intersect, TransformBoxStateSingleton } from "../../../src/singletons";
...
const testPlugin: EditorPlugin<InfiniteCanvasResources> = {
  ...
  singletons: Object.values(allSingletons).filter(
