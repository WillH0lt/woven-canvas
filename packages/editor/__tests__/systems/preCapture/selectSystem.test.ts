...
import { Block, Selected } from "../../../src/components";
import { Intersect, SelectionStateSingleton } from "../../../src/singletons";
import {
  pointerSystem,
  attachPointerListeners,
  detachPointerListeners,
} from "../../../src/systems/input";
import { selectSystem, intersectSystem } from "../../../src/systems/preCapture";
import {
  DeselectAll,
  CloneEntities,
  UncloneEntities,
...
const testPlugin: EditorPlugin = {
  ...
  inputSystems: [pointerSystem],
  preCaptureSystems: [intersectSystem, selectSystem],
  setup(ctx) {
    // Attach pointer listeners to capture DOM events
...
describe("PreCaptureSelect", () => {
  ...
  describe("deselection", () => {
    ...
    it("should NOT spawn DeselectAll command when shift is held", async () => {
      ...
      // Set shift key state directly (more isolated than DOM events)
      editor.nextTick((ctx) => {
