import { addComponent, Block, createEntity, Editor } from '@woven-canvas/core'
...
describe('UpdateDragHandler', () => {
  ...
  describe('rotate handle movement', () => {
    ...
    it('should warn when no transform box found for rotation', async () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith('No transform box found for rotation')
      warnSpy.mockRestore()
    })
  })
  ...
  describe('scale handle movement', () => {
    ...
    it('should warn when no transform box found for scaling', async () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith('No transform box found for scaling')
      warnSpy.mockRestore()
    })
  })
