...
describe('Keyboard System', () => {
  ...
  describe('key state tracking', () => {
    ...
    it('should track key up state', async () => {
      const ctx = editor._getContext()!
      ...
      domElement.dispatchEvent(new KeyboardEvent('keyup', { code: 'KeyA', bubbles: true }))
      await editor.tick()
    ...
    it('should track multiple keys simultaneously', async () => {
      const ctx = editor._getContext()!

      domElement.dispatchEvent(new KeyboardEvent('keydown', { code: 'KeyA', bubbles: true }))
      domElement.dispatchEvent(new KeyboardEvent('keydown', { code: 'KeyB', bubbles: true }))
      domElement.dispatchEvent(new KeyboardEvent('keydown', { code: 'KeyC', bubbles: true }))
  ...
  describe('modifier tracking', () => {
    it('should track shift modifier', async () => {
      const ctx = editor._getContext()!
    ...
    it('should track alt modifier', async () => {
      const ctx = editor._getContext()!
    ...
    it('should track ctrl/meta modifier as modDown', async () => {
      const ctx = editor._getContext()!
    ...
    it('should track meta key as modDown', async () => {
      const ctx = editor._getContext()!
  ...
  describe('blur handling', () => {
    ...
    it('should reset modifiers on blur', async () => {
      const ctx = editor._getContext()!
...
describe('Keyboard - multiple instances', () => {
  it('should isolate keyboard state between editor instances', async () => {
    ...
    domElement1.dispatchEvent(new KeyboardEvent('keydown', { code: 'KeyA', bubbles: true }))
