...
@customElement('ic-text-checkbox-button')
export class ICTextCheckboxButton extends SignalWatcher(ICMenuIconButton) {
  ...
  protected onClick(): void {
    this.commands.textEditor.toggleCheckbox()
  }
}

declare global {
  interface HTMLElementTagNameMap {
    'ic-text-checkbox-button': ICTextCheckboxButton
  }
}
