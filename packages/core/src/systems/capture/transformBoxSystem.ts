import { type Context, createEntity, defineQuery, type EntityId, hasComponent, removeComponent } from '@woven-ecs/core'
...
import { EditAfterPlacing } from '../../components/EditAfterPlacing'
