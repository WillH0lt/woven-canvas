...
import { ScrollEdgesStateSingleton } from '../../singletons/ScrollEdgesStateSingleton'
import { SelectionStateSingleton } from '../../singletons/SelectionStateSingleton'
import { type CorePluginOptions, getPluginResources, ScrollEdgesState, SelectionState } from '../../types'
...
function getEdgeScrollingOptions(ctx: Context) {
  return getPluginResources<CorePluginOptions>(ctx, CORE_PLUGIN_NAME).edgeScrolling
}
