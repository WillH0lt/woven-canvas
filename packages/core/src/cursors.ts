import type { CursorDef } from './types'
...
// SVG Templates
//
// Every cursor draws its strokes twice: a wide white pass underneath and the
// black pass on top, so the pointer stays legible over dark artwork.
