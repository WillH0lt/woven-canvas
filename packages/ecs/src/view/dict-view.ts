...
import type { ArrayView } from "./array-view";
import type { VectorView } from "./vector-view";

export class DictView<T extends object>
  ...
  implements ComplexView<T>
{
  ...
  set<P extends keyof T>(key: P, value: T[P]) {
    ...
    (
      (this.constructor as typeof DictView).ValuesView.View as ViewConstructor<
        T[P]
      >
    ).encode(value, this, this.byteOffset + offset[0], offset[1]);
    return;
  }
