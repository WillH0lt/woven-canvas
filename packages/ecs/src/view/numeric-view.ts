import type { PrimitiveView, ViewConstructor } from "./view-types";

export class Uint8View
  extends DataView<ArrayBufferLike>
  implements PrimitiveView<number>
{
  static viewLength = 1;
  ...
  static from(value: number) {
    const typeView = new this(new SharedArrayBuffer(this.viewLength));
...
export class BigInt64View
  extends DataView<ArrayBufferLike>
  implements PrimitiveView<bigint>
{
  static viewLength = 8;
