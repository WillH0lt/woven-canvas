  ...
  implements ComplexView<T>
{
  ...
  static initialize<T extends object>(
    ...
    const { getDefaultConstructor, getDefaultData } =
      Factory.constructor as typeof View;
    ...
    const ObjectConstructor =
      constructor || getDefaultConstructor(required as Array<keyof T>, layout);
