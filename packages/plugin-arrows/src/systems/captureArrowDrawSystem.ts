 ...
 */
export const captureArrowDrawSystem = defineEditorSystem({ phase: 'capture', priority: 100 }, (ctx) => {
  ...
  state.kind = leftMouseTool === 'elbow-arrow' ? ArrowKind.Elbow : ArrowKind.Arc
