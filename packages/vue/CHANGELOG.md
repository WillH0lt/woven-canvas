...
- Updated dependencies [10d4b07]
  - @woven-canvas/core@1.3.4
  - @woven-canvas/asset-sync@1.0.9
...
- Updated dependencies [ac6aec0]
  - @woven-canvas/core@1.3.2

## 1.7.0

### Minor Changes

- 0354e72: The font-size menu can work in a unit other than stored px, for canvases whose page is bigger than screen scale. On a print-pixel page where body text is stored as 100px, every number in the menu reads inflated — presets running 67 / 100 / 167 / 400, and `400` in the custom box for what a person thinks of as 96pt. `TextFontSizeButton` now takes `pxPerUnit`, and multiplies by it on the way to the text:
...
- Updated dependencies [f91b7f9]
  - @woven-canvas/core@1.0.13
