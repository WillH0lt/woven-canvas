...
<template>
  <MenuDropdown v-if="state.showTextMenuButtons" title="Text Color">
    <template #button>
      <div class="wov-text-color-button">
        <div class="wov-text-icon-container">
          <svg
          ...
          <div class="wov-color-underline" :style="underlineStyle" />
        </div>
