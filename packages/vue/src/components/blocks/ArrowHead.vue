...
const geometry = computed(() => {
  ...
  const unitDir: Vec2 = [props.direction[0] / dirLen, props.direction[1] / dirLen]
...
const deltaPoints = computed(() => {
  ...
  const p1: Vec2 = [back[0] + perpDir[0] * (headWidth / 2), back[1] + perpDir[1] * (headWidth / 2)]
  const p2: Vec2 = [back[0] - perpDir[0] * (headWidth / 2), back[1] - perpDir[1] * (headWidth / 2)]
...
const diamondPoints = computed(() => {
  ...
  const left: Vec2 = [mid[0] + perpDir[0] * (width / 2), mid[1] + perpDir[1] * (width / 2)]
  const right: Vec2 = [mid[0] - perpDir[0] * (width / 2), mid[1] - perpDir[1] * (width / 2)]
