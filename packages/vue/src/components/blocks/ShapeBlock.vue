...
import { Text, VerticalAlign, VerticalAlignment, Shape, StrokeKind } from '@woven-canvas/core'
...
const shapePath = computed(() => SHAPES[shape.value?.kind ?? 'rectangle'] ?? SHAPES.rectangle)
