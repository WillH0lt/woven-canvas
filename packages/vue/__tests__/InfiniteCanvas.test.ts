...
describe("InfiniteCanvas", () => {
  ...
  describe("props", () => {
    ...
    it("should include SelectionPlugin by default", async () => {
      ...
      const editorInstance = getLastEditorInstance();
      const hasSelectionPlugin = editorInstance.options.plugins?.some(
        (p: any) => p.name === "selection"
      );
    ...
    it("should pass custom plugins to Editor", async () => {
      ...
      const editorInstance = getLastEditorInstance();
      const hasCustomPlugin = editorInstance.options.plugins?.some(
        (p: any) => p.name === "custom-plugin"
      );
