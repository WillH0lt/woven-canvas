import type { FloatingMenuButtonInput } from '@infinitecanvas/core'
...
export const roughShapeFloatingMenuButtons: FloatingMenuButtonInput[] = [strokeButton, fillButton]
