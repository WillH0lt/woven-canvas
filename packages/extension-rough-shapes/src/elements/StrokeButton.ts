...
@customElement('ic-rough-shape-stroke-button')
export class StrokeButtonElement extends AbstractButtonElement {
  protected icon = html`
...
declare global {
  interface HTMLElementTagNameMap {
    'ic-rough-shape-stroke-button': StrokeButtonElement
  }
}
