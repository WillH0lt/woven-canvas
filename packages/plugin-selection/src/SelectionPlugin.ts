...
import { type SelectionPluginOptions, type SelectionPluginOptionsInput, SelectionPluginOptionsSchema } from './types'
 ...
 * ```
 */
export const SelectionPlugin: EditorPluginFactory<SelectionPluginOptionsInput, SelectionPluginOptions> = (
  options = {},
) => createSelectionPlugin(options)
