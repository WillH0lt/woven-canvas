...
import type { SyncStorage } from "./storage/SyncStorage";
import type {
  ComponentData,
  FieldTimestamps,
  Patch,
...
export interface RoomOptions {
  ...
  onSessionRemoved?: (
    room: Room,
    info: { sessionId: string; remaining: number },
  ) => void;
...
export class Room {
  ...
  private applyAndBroadcast(
    session: Session,
    req: { documentPatches?: Patch[]; ephemeralPatches?: Patch[] },
  ): void {
