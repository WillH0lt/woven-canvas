 ...
 *
 * Used for cloning operations to create deterministic UUIDs
 * that can be reversed (unclone) using the same seed.
 *
 * @param originalUuid - The original entity's UUID
 * @param generatorSeed - Seed for the random generator
 * @returns UUID string in format xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx
 */
export function generateUuidBySeed(
  originalUuid: string,
