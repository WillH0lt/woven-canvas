...
An interactive particle system demo showcasing the `@infinitecanvas/ecs` framework integrated with Three.js and multithreaded physics simulation using Web Workers.
...
Open your browser to `http://localhost:5175` (or the port shown in terminal)
...
This demo illustrates key concepts of the `@infinitecanvas/ecs` framework:
